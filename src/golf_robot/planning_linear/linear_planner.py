...
def send_swing(
    ...
    *,
    ...
    x_start=-0.64026*1.5,
    x_end=-0.64026*0.5,
    y_ball=-0.59278, #-0.546
    z_ball=0.15512, #-0.006
    # angles
    ...
    base_rvec=(-1.4684, -1.0300, 1.4412),  # your 0° club pose (UR axis-angle) #base_rvec=(0.8161, -1.4130, -0.8167),  
    ...
    time.sleep(8)  # give UR time to process
