...
def generate_disc_positions(num_discs, x_min, x_max, y_min, y_max, hole_xy):
    hole_x, hole_y = hole_xy
    disc_positions = []
    min_dist_from_objects = 0.15 
...
# Public API
# ---------------------------------------------------------------------
def run_sim(aim_yaw_deg, vx_des, hole_pos_xy, cfg, disc_positions):
    """
