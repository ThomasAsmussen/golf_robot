...
// -------------------- User config --------------------
static const std::string CSV_IN   = "log/trajectory_sim.csv";
static const std::string CSV_OUT  = "/home/thomas/Documents/masters_project/golf_robot/log/streamed_measurements.csv";
