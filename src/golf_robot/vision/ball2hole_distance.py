...
def get_ball_final_position(camera_index=0, chosen_hole=None, use_cam=True, debug=True, operating_system="windows"):
    # Read image
    frame_height = 1080
    frame_width = 1920
    if use_cam:
    ...
    if chosen_hole is None:
        ...
        print(f"Chosen hole: {chosen_hole}")
        print(f"Hole positions: {hole_positions}")
